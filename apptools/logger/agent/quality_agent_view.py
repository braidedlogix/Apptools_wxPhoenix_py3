...
class QualityAgentView(Dialog):
    ...
    def _create_email_info(self, parent):
        ...
        sizer.Add(title_field, 1, wx.EXPAND | wx.ALL | wx.ALIGN_RIGHT |
                  wx.CLIP_CHILDREN)
        ...
        sizer.Add(to_field, 1, wx.EXPAND | wx.ALL | wx.ALIGN_RIGHT |
                  wx.CLIP_CHILDREN)
        ...
        sizer.Add(cc_field, 1, wx.EXPAND | wx.ALL | wx.ALIGN_RIGHT |
                  wx.CLIP_CHILDREN)
        ...
        sizer.Add(from_field, 1, wx.EXPAND | wx.ALL | wx.ALIGN_RIGHT |
                  wx.CLIP_CHILDREN)
        ...
        sizer.Add(smtp_server_field, 1, wx.EXPAND | wx.ALL | wx.ALIGN_RIGHT |
                  wx.CLIP_CHILDREN)
    ...
    def _on_project(self, event):
        ...
        if event.Checked():
            cb.SetLabel("Include Workspace Files (approx. %.2f MBytes)" %
